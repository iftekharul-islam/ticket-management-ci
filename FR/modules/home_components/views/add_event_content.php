        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <?=form_open_multipart('home_components/add_event_content', array('class' => 'form-horizontal'))?>
                    <div class="form-body">
                        <div class="form-group ">
                            <div class="col-md-6 margin-bottom-20">
                                <label>Placement</label>
                                <?=form_dropdown('placement', array("bottom" => "Bottom", "top" => "Top", "sidebar" => "Sidebar"), set_value('placement'), 'class="form-control"')?>
                            </div>
                            <div class="col-md-6 margin-bottom-20">
                                <label>Select Type</label>
                                <?=form_dropdown('type', array("category" => "Category", "events" => "Events / Performer"), set_value('type'), 'class="form-control"')?>
                            </div>
                            <div class="col-md-6 margin-bottom-20">
                                <label>Event / Category url</label>
                                <input name="event_url" class="form-control" type="text" value="<?=set_value('event_url')?>" placeholder="" required=""> 
                            </div>
                            ...
                            <div class="col-md-12 margin-bottom-20">
                                <label>Content</label>
                                <textarea class="tinymce" name="content" class="content"> <?=set_value('content')?></textarea>
                            </div>
                        </div>
