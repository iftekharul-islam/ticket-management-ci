 ...
 */
$config['site_title']                 = "fazlerabby.com";       // Site Title, example.com
$config['admin_email']                = "netrubby@gmail.com"; // Admin Email, admin@example.com
...
$config['message_start_delimiter'] = '<p style="margin-bottom: 0">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p style="margin-bottom: 0">';		// Error message start delimiter
