...
class Ion_auth
{
	...
	public function forgotten_password($identity){
		if ( $this->ion_auth_model->forgotten_password($identity) ){
			...
			if ($user){
				...
				$data['identity'] = $user->{$this->config->item('identity', 'ion_auth')};
				$data['forgotten_password_code'] = $user->forgotten_password_code;
				...
				if(!$this->config->item('use_ci_email', 'ion_auth')){
					...
					$this->email->clear();
					$this->email->from($data['site']->reply_email, $data['site']->app_title);
	...
	public function logout(){
            ...
            if (get_cookie($this->config->item('identity_cookie_name', 'ion_auth'))) delete_cookie($this->config->item('identity_cookie_name', 'ion_auth'));
            if (get_cookie($this->config->item('remember_cookie_name', 'ion_auth'))) delete_cookie($this->config->item('remember_cookie_name', 'ion_auth'));
